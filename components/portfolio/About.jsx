...
const services = [
  ...
  },
  {
    ...
    items: ["JavaScript (ES6+)", "TypeScript", "Clean and maintainable code"],
  },
];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          <p className="text-muted-foreground leading-relaxed text-lg">
            I'm Vigneshwar, a fresher frontend developer with strong hands-on
            experience in React, Next.js, and modern frontend technologies. I
