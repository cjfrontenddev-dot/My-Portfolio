      ...
      <div className="max-w-6xl mx-auto w-full">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1 text-center lg:text-left">
            <p className="text-primary font-medium mb-2 text-lg">Hi There!</p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-secondary bg-secondary text-secondary-foreground hover:bg-secondary/90 hover:text-white font-semibold px-8"
          ...
          <div className="order-1 lg:order-2 relative flex justify-center">
            <div className="relative">
              ...
              {/* Profile Image */}
              <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-primary shadow-2xl bg-white flex items-center justify-center">
                <img
                  src="/images/profile.png"
                  alt="Vigneshwar - Frontend Developer"
                  className="max-w-full max-h-full object-contain translate-y-7 scale-150"
                />
              </div>
